                                    ...
                                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 sm:p-7 text-white">
                                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-3">
                                                <a
                                                    href="tel:+74742200719"
                                                    className="inline-flex items-center justify-center px-4 py-2.5 bg-white text-blue-700 font-semibold rounded-xl hover:bg-blue-50 transition"
                                                >
                                                    Позвонить
                                                </a>
                                                <a
                                                    href="https://wa.me/79272588921"
                                                    className="inline-flex items-center justify-center px-4 py-2.5 bg-white/10 text-white font-semibold rounded-xl border border-white/30 hover:bg-white/20 transition"
                                                >
                                                    Написать в WhatsApp
                                                </a>
                                            </div>
