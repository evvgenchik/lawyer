        ...
        setTimeout(() => {
            ...
            switch (reply) {
                ...
                case '📧 Написать на почту':
                    botResponse = 'Вы можете написать нам на почту: kodex48@mail.ru или заполнить форму на сайте для быстрого ответа.';
                    break;
                default:
    ...
    const handleSendMessage = () => {
        ...
        setTimeout(() => {
            ...
            const botMessage = {
                ...
                text: 'Спасибо за ваше сообщение! Наш юрист ответит вам в ближайшее время. Для срочной консультации звоните: +7 (929) 012-38-48',
                isBot: true,
                timestamp: new Date()
            };
