...
const FAQ = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: 'Да, мы работаем со всеми категориями военнослужащих: мобилизованными, контрактниками, добровольцами и членами их семей. Предоставляем консультации дистанционно по всей России через телефон и Telegram.',
            icon: '🛡️'
        },
        {
            question: 'Как оформить развод и алименты в Липецке?',
            answer: 'Мы оказываем полный спектр услуг по семейному праву: подготовка документов для развода, представительство в суде, взыскание алиментов, раздел имущества, определение места жительства детей. Первичная консультация бесплатная, работаем быстро и конфиденциально.',
            icon: '👨‍⚖️'
        },
        {
            question: 'Помогаете ли вы с долгами и кредитами?',
            answer: 'Да, мы предоставляем юридическую помощь по взысканию долгов, защите от коллекторов, оспариванию неправомерных действий банков, реструктуризации кредитов и банкротству физических лиц. Консультация юриста в Липецке бесплатно.',
            icon: '💳'
        },
        {
            question: 'Как проходит защита в суде?',
            answer: 'Наши юристы представляют ваши интересы в судах всех инстанций: гражданские, уголовные, административные дела. Подготавливаем иски, жалобы, апелляции, собираем доказательства и добиваемся максимально выгодного для вас решения.',
            icon: '⚖️'
        },
        {
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-8 sm:mb-12">
                    ...
                    <p className="text-base sm:text-lg lg:text-xl text-gray-700 leading-relaxed">
                        Ответы на важные вопросы о юридической помощи военнослужащим и гражданам
                    </p>
                </div>
