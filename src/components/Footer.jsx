                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
                    <div className="col-span-1 sm:col-span-2 lg:col-span-1">
                        <div className="flex items-center">
                            <h3 className="text-xl sm:text-2xl font-bold text-white">ЮРИДИЧЕСКАЯ ПОМОЩЬ</h3>
                        </div>
                        <p className="mt-3 sm:mt-4 text-gray-300 text-sm leading-relaxed">
                            Профессиональная юридическая помощь военнослужащим, мобилизованным и добровольцам в Липецке и по всей России.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 sm:space-y-3">
                            <li>
                                <a href="tel:+74742200719" className="text-gray-300 hover:text-white flex items-center text-sm sm:text-base">
                                    ...
                                    <span className="break-all">+7 (474) 220-07-19</span>
                                </a>
                            </li>
                            <li>
                                <a href="mailto:lipetskcentrprava@gmail.com" className="text-gray-300 hover:text-white flex items-center text-sm sm:text-base">
                                    <svg className="h-4 w-4 sm:h-5 sm:w-5 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>
                                    <span className="break-all">lipetskcentrprava@gmail.com</span>
                                </a>
                            </li>
                            <li>
                                <div className="text-gray-300 flex items-start text-sm sm:text-base">
                                    ...
                                    <span>г. Липецк, Коммунальная площадь, 9, 1 этаж</span>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-1 sm:space-y-2">
                            <li className="text-gray-300 text-sm sm:text-base">
                                <span className="font-medium">ПН-ПТ:</span> 9:00-21:00
                            </li>
                            <li className="text-gray-300 text-sm sm:text-base">
                                <span className="font-medium">СБ-ВС:</span> 9:00-18:00
                            </li>
                        </ul>
                    </div>
