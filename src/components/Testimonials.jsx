                ...
                <div className="relative">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        {testimonials.map((testimonial, index) => (
                            ...
                            >
                                <div className={`relative backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border-2 transition-all duration-300 flex flex-col h-full ${
                                    activeTestimonial === index
                                    ...
                                    <blockquote className="text-gray-700 mb-4 sm:mb-6 italic text-base sm:text-lg leading-relaxed flex-grow">
                                        "{testimonial.text}"
                                    </blockquote>
