                        ...
                        {visibleReviews.map((testimonial, index) => (
                            ...
                            >
                                <div className={`relative backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border-2 transition-all duration-300 flex flex-col h-full overflow-hidden`}>
                                    ...
                                    <blockquote className="text-gray-700 mb-6 italic text-base sm:text-lg leading-relaxed flex-grow overflow-y-auto scrollbar-none [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                                        {testimonial.text}
                                    </blockquote>
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="text-right">
                                            <div className="text-md sm:text-md font-bold text-green-600">
                                                {testimonial.amount.split('\n').map((line, idx) => (
                                                    <span key={idx}>
                                                        {idx > 0 && <br />}
                                                        {line}
                                                    </span>
